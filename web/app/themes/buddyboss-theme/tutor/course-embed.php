...
<div class="tutor-card tutor-course-card">
	...
	<div class="tutor-card-body">
		...
		<div class="tutor-meta tutor-mt-auto">
			<div>
				<a href="<?php echo esc_url( $profile_url ); ?>" class="tutor-d-flex <?php echo bb_theme_enable_tutorlms_override() ? 'bb-tutor-avatar' : ''; ?>" target="_parent">
					<?php
	...
	<div class="tutor-card-footer">
		<a href="<?php the_permalink(); ?>" class="tutor-btn tutor-btn-outline-primary tutor-btn-md tutor-btn-block " target="_parent">
			<?php esc_html_e( 'View Details', 'buddyboss-theme' ); ?>
		</a>
	</div>
</div>
