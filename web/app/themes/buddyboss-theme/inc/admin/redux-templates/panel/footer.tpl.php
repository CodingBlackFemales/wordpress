	...
	<div id="redux-footer">
		...
		<div class="redux-action_bar">
			...
			if ( false === $this->parent->args['hide_save'] ) {
				submit_button( esc_html__( 'Save Changes', 'buddyboss-theme' ), 'primary', 'redux_save', false, array( 'id' => 'redux_bottom_save' ) );
			}

			if ( false === $this->parent->args['hide_reset'] ) {
				submit_button( esc_html__( 'Reset Section', 'buddyboss-theme' ), 'secondary', $this->parent->args['opt_name'] . '[defaults-section]', false, array( 'id' => 'redux-defaults-section-bottom' ) );
				submit_button( esc_html__( 'Reset All', 'buddyboss-theme' ), 'secondary', $this->parent->args['opt_name'] . '[defaults]', false, array( 'id' => 'redux-defaults-bottom' ) );
			}
			?>
		</div>
		<div class="redux-ajax-loading" alt="<?php esc_html_e( 'Working...', 'buddyboss-theme' ); ?>">&nbsp;</div>
		<div class="clear"></div>
	</div>
</div>
