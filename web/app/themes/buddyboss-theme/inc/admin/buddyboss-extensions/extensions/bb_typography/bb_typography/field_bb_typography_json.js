...
(function( $ ) {
    ...
    $( document ).ready(
        function() {
            //redux.field_objects.bb_typography.init();
        }
    );
    ...
    redux.field_objects.bb_typography.change = function( container ) {
        var $data = {};
    ...
    redux.field_objects.bb_typography.select = function( selector, skipCheck ) {
        ...
        if ( isSelecting === true ) {
            ...
            google = redux.field_objects.bb_typography.makeBool( $( '#' + mainID + ' .redux-typography-google-font' ).val() ); // Check if font is a google font
        }
