...
// Don't duplicate me!
	if ( ! class_exists( 'ReduxFramework_extension_bb_typography' ) ) {
		 ...
		 * @since       1.0.0
		 */
		class ReduxFramework_extension_bb_typography {
			...
			public $field_id = '';
			private $class_css = '';
			public $field_name = 'bb_typography';
