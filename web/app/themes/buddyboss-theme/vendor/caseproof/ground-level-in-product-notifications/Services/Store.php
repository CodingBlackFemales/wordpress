...
namespace BuddyBossTheme\GroundLevel\InProductNotifications\Services;

use BuddyBossTheme\GroundLevel\Container\Service;
use BuddyBossTheme\GroundLevel\InProductNotifications\Models\Notification;
...
class Store extends Service
{
    ...
    public function markRead(string $id) : self
    {
        if (isset($this->data[$id])) {
            $this->update($id, ['read' => \true, 'readAt' => Time::now()]);
        }
        return $this;
    }
    /**
