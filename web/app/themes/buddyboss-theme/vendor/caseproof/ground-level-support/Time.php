...
namespace BuddyBossTheme\GroundLevel\Support;

use DateTime;
use DateTimeZone;
use BuddyBossTheme\GroundLevel\Support\Exceptions\TimeTravelError;
use Exception;
...
class Time
{
    ...
    {
        $disabled = \defined('BuddyBossTheme\\GRDLVL_CLOCK_DISABLE_TIME_TRAVEL') ? GRDLVL_CLOCK_DISABLE_TIME_TRAVEL : \false;
        return !$disabled && (\defined('BuddyBossTheme\\GRDLVL_TESTING') && GRDLVL_TESTING);
    }
    /**
     * Freezes time.
     *
    ...
    {
        $func = \defined('BuddyBossTheme\\GRDLVL_CLOCK_NOW_FUNCTION') ? GRDLVL_CLOCK_NOW_FUNCTION : 'current_time';
