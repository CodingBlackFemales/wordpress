...
if ( ( class_exists( 'LearnDash_Settings_Section' ) ) ) {
	...
	class Licensing_Settings_Section extends LearnDash_Settings_Section {
		...
		public function enqueue_scripts() {
			...
			if ( is_object( $screen ) && $screen->id === 'admin_page_learndash_lms_advanced'
				 && isset( $_GET['section-advanced'] ) && $_GET['section-advanced'] === 'setting_lms_licensing'
			) {
	...
	add_action(
		...
		function ( string $settings_page_id ) {
			if (
				$settings_page_id === 'learndash_lms_advanced' &&
				isset( $_GET['section-advanced'] ) &&
				$_GET['section-advanced'] === 'setting_lms_licensing' ) {
