...
<form class="resume_filters">
	...
	<div class="search_resumes">
		...
		<div class="search_skills resume-filter">
			<label for="search_skills"><?php _e( 'Skills', 'wp-job-manager-resumes' ); ?></label>
			<input type="text" name="search_skills" id="search_skills" placeholder="<?php _e( 'Any Skills', 'wp-job-manager-resumes' ); ?>" value="<?php echo esc_attr( $skills ); ?>" />
		</div>
