...
class WP_Resume_Manager_Admin {
	...
	public function admin_enqueue_scripts() {
		...
		wp_enqueue_style( 'resume_manager_admin_css', RESUME_MANAGER_PLUGIN_URL . '/assets/dist/css/admin.css', array( 'dashicons' ), RESUME_MANAGER_VERSION );
		wp_enqueue_script( 'resume_manager_admin_js', RESUME_MANAGER_PLUGIN_URL . '/assets/dist/js/admin.js', array( 'jquery', 'jquery-ui-datepicker', 'jquery-ui-sortable' ), RESUME_MANAGER_VERSION, true );
	}
