<?php
/**
 * Elegant footer template.
 *
 * This template can be overridden by copying it to yourtheme/wpforms/emails/elegant-footer.php.
 *
 * @since 1.8.5
 */
										...
										echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
											...
											sprintf(
												wp_kses( /* translators: %1$s - site URL; %2$s - site title. */
													__( 'Sent from <a href="%1$s">%2$s</a>', 'wpforms' ),
													[
														'a' => [
															'href' => [],
														],
