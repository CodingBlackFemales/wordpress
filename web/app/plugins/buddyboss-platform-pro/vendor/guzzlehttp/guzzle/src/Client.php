...
use BuddyBossPlatformPro\GuzzleHttp\Cookie\CookieJar;
use BuddyBossPlatformPro\GuzzleHttp\Exception\GuzzleException;
use BuddyBossPlatformPro\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \BuddyBossPlatformPro\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
