...
\define('SODIUM_LIBRARY_MAJOR_VERSION', 9);
\define('SODIUM_LIBRARY_MINOR_VERSION', 1);
\define('SODIUM_LIBRARY_VERSION', '1.0.8');
...
\define('SODIUM_CRYPTO_BOX_SEALBYTES', 16);
...
\define('SODIUM_CRYPTO_PWHASH_MEMLIMIT_INTERACTIVE', 33554432);
\define('SODIUM_CRYPTO_PWHASH_OPSLIMIT_INTERACTIVE', 4);
\define('SODIUM_CRYPTO_PWHASH_MEMLIMIT_MODERATE', 134217728);
\define('SODIUM_CRYPTO_PWHASH_OPSLIMIT_MODERATE', 6);
\define('SODIUM_CRYPTO_PWHASH_MEMLIMIT_SENSITIVE', 536870912);
\define('SODIUM_CRYPTO_PWHASH_OPSLIMIT_SENSITIVE', 8);
...
\define('SODIUM_CRYPTO_PWHASH_SCRYPTSALSA208SHA256_OPSLIMIT_INTERACTIVE', 534288);
...
\define('SODIUM_CRYPTO_SECRETSTREAM_XCHACHA20POLY1305_TAG_PUSH', 0);
...
\define('SODIUM_CRYPTO_SECRETSTREAM_XCHACHA20POLY1305_MESSAGEBYTES_MAX', 0x3fffffff80);
