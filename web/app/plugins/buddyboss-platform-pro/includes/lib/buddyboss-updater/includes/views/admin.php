<div class="wrap buddyboss-updater-wrap">
    ...
    <div class="buddyboss-updater-block-container">
        <div class="buddyboss-updater-block">
            <div class="inside">
                <h2><?php _e( 'Auto Connect (Recommended)', 'buddyboss-pro' ); ?></h2>
                <p>
					<?php printf( __( 'Click the "Connect to BuddyBoss" button to log into your BuddyBoss account. Then click "Allow" to have your license automatically filled in to activate your products.', 'buddyboss-pro' ) ); ?>
                </p>
                <br/>
                <button id="btn_bb_connect" class="button button-primary">
					<?php _e( 'Connect to BuddyBoss', 'buddyboss-pro' ); ?>
                </button>
                <span class="connecting" style="display:none;"><?php _e( 'Connecting', 'buddyboss-pro' ); ?></span>
            </div>
        </div>
        ...
        <div class="buddyboss-updater-block">
            <div class="inside">
                ...
                <li>
					<?php _e( 'Find your product\'s license key', 'buddyboss-pro' ); ?>
                </li>
                <li>
					<?php _e( 'Enter your license key below', 'buddyboss-pro' ); ?>
                </li>
                <li>
					<?php _e( 'Enter your BuddyBoss account email', 'buddyboss-pro' ); ?>
                </li>
                <li>
					<?php _e( 'Click "Update License"', 'buddyboss-pro' ); ?>
                </li>
                </p>
            </div>
        </div>
