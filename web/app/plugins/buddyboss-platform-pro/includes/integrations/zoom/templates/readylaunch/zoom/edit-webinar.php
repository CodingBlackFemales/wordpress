...
<div class="bb-rl-edit-event-header">
	<h4 class="bb-title"><?php esc_html_e( 'Edit Webinar', 'buddyboss-pro' ); ?></h2>
</div>
...
<div class="bb-rl-edit-event-wrapper">
	<div class="bp-webinar-fields-wrap">
		...
		<footer class="bb-rl-zoom-event-footer webinar-item text-right" data-id="<?php bp_zoom_webinar_id(); ?>" data-zoom-type="<?php echo esc_attr( bp_get_zoom_webinar_zoom_type() ); ?>" data-action="edit-cancel">
			...
			<a href="#" id="bp-zoom-webinar-cancel-edit" class="text-button small bb-rl-button bb-rl-button--secondaryFill bb-rl-button--small"><?php esc_html_e( 'Cancel', 'buddyboss-pro' ); ?></a>
			<a id="bp-zoom-webinar-form-submit" name="bp-zoom-webinar-form-submit" class="button submit bb-rl-button bb-rl-button--brandFill bb-rl-button--small"><?php esc_html_e( 'Update Webinar', 'buddyboss-pro' ); ?></a>
		</footer>
	</div>
</div>
