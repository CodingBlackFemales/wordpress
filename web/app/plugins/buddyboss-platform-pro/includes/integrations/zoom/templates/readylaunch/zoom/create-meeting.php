...
<div class="bb-rl-create-event-header">
    ...
    <a class="bb-rl-close-create-meeting-form" href="#" aria-label="<?php esc_attr_e( 'Close', 'buddyboss-pro' ); ?>">
				...
				<div class="bb-field-wrap">
					...
					<div class="bb-meeting-input-wrap">
						<div class="bb-field-wrap checkbox-row">
							<input type="checkbox" name="bp-zoom-meeting-notification" id="bp-zoom-meeting-notification" value="yes" aria-label="<?php esc_attr_e( 'Send meeting notifications', 'buddyboss-pro' ); ?>" class="bs-styled-checkbox"/>
