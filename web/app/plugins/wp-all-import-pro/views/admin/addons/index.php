<div class="wrap" style="max-width:970px;">
	...
	<h2><?php _e('WP All Import Add-ons', 'wp-all-import-pro') ?></h2>
		
	<div id="pmxi-add-ons" class="clear">
		
		<div class="pmxi-add-on-group clear">
			<h3><?php _e('Premium Add-ons', 'wp-all-import-pro'); ?></h3>
				...
				<div class="footer">
					...
					<?php elseif ($addon['required_plugins']): ?>
						...
						foreach ($addon['required_plugins'] as $name => $active): 
							if (!$active){
								?>
								<p style="margin:3px 0px;"><?php echo $name . __(' required', 'wp-all-import-pro'); ?></p>
								<?php
		...
		<div class="pmxi-add-on-group clear">
			<h3><?php _e('Free Add-ons', 'wp-all-import-pro'); ?></h3>
