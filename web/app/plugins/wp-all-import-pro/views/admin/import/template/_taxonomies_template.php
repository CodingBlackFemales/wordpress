...
?>
	<div class="wpallimport-collapsed closed wpallimport-section">
		<div class="wpallimport-content-section">
			...
			<div class="wpallimport-collapsed-content" style="padding: 0;">
				<div class="wpallimport-collapsed-content-inner" style="padding-bottom:0;">
					<input type="button" rel="taxonomies_hints" value="<?php _e('Show Hints', 'wp-all-import-pro');?>" class="show_hints">
												...
												<div class="switcher-target-tax_assing_<?php echo $ctx->name;?>">
													<div class="input sub_input">
														<div class="input">
															...
															<label for="tax_logic_single_<?php echo $ctx->name;?>"><?php printf(__('Each %s has just one %s', 'wp-all-import-pro'), $custom_type->labels->singular_name, $ctx->labels->singular_name); ?></label>
															<div class="switcher-target-tax_logic_single_<?php echo $ctx->name;?> sub_input">
																...
																<div class="input tax_is_full_search_single" style="margin: 10px 0;">
																	...
																	<label for="tax_is_full_search_single_<?php echo $ctx->name;?>"><?php printf(__('Try to match terms to existing child %s', 'wp-all-import-pro'), $ctx->labels->name); ?></label>
																	<div class="switcher-target-tax_is_full_search_single_<?php echo $ctx->name; ?> sub_input">
																		<div class="input tax_assign_to_one_term_single" style="margin: 10px 0;">
																			...
																			<label for="tax_assign_to_one_term_single_<?php echo $ctx->name;?>"><?php printf(__('Only assign %s to the imported %s, not the entire hierarchy', 'wp-all-import-pro'), $custom_type->labels->name, $ctx->labels->singular_name); ?></label>
																			<a href="#help" class="wpallimport-help" title="<?php _e('By default all categories above the matched category will also be assigned to the post. If enabled, only the imported category will be assigned to the post.', 'wp-all-import-pro'); ?>" style="position:relative; top: -1px;">?</a>
																		</div>
																	</div>
																</div>
															</div>															
														...
														<div class="input">
															...
															<label for="tax_logic_multiple_<?php echo $ctx->name;?>"><?php printf(__('Each %s has multiple %s', 'wp-all-import-pro'), $custom_type->labels->singular_name, $ctx->labels->name); ?></label>
															<div class="switcher-target-tax_logic_multiple_<?php echo $ctx->name;?> sub_input">
																...
																<label><?php _e('Separated by', 'wp-all-import-pro'); ?></label>										
																...
																<div class="input tax_is_full_search_multiple" style="margin: 10px 0;">
																	...
																	<label for="tax_is_full_search_multiple_<?php echo $ctx->name;?>"><?php printf(__('Try to match terms to existing child %s', 'wp-all-import-pro'), $ctx->labels->name); ?></label>
																	<div class="switcher-target-tax_is_full_search_multiple_<?php echo $ctx->name; ?> sub_input">
																		<div class="input tax_assign_to_one_term_multiple" style="margin: 10px 0;">
																			...
																			<label for="tax_assign_to_one_term_multiple_<?php echo $ctx->name;?>"><?php printf(__('Only assign %s to the imported %s, not the entire hierarchy', 'wp-all-import-pro'), $custom_type->labels->name, $ctx->labels->singular_name); ?></label>
																			<a href="#help" class="wpallimport-help" title="<?php _e('By default all categories above the matched category will also be assigned to the post. If enabled, only the imported category will be assigned to the post.', 'wp-all-import-pro'); ?>" style="position:relative; top: -1px;">?</a>
																		</div>
																	</div>
																</div>
														...
														<div class="input">
															...
															<label for="tax_logic_hierarchical_<?php echo $ctx->name;?>"><?php printf(__('%ss have hierarchical (parent/child) %s (i.e. Sports > Golf > Clubs > Putters)', 'wp-all-import-pro'), $custom_type->labels->singular_name, $ctx->labels->name); ?></label>
															<div class="switcher-target-tax_logic_hierarchical_<?php echo $ctx->name;?> sub_input">
																<div class="input">
																	...
																	<label for="hierarchical_logic_entire_<?php echo $ctx->name;?>"><?php _e('An element in my file contains the entire hierarchy (i.e. you have an element with a value = Sports > Golf > Clubs > Putters)', 'wp-all-import-pro'); ?></label>
																	<div class="switcher-target-hierarchical_logic_entire_<?php echo $ctx->name;?> sub_input" style="margin-left: 20px; padding-left: 20px;">
																		...
																		<div class="input">
																			...
																			<label for="tax_hierarchical_last_level_assign_<?php echo $ctx->name; ?>"><?php printf(__('Only assign %s to the bottom level term in the hierarchy', 'wp-all-import-pro'), $custom_type->label) ?></label>			
																		</div>
																		<div class="input">
																			...
																			<label for="is_tax_hierarchical_group_delim_<?php echo $ctx->name; ?>"><?php printf(__('Separate hierarchy groups via symbol', 'wp-all-import-pro'), $custom_type->label) ?></label>			
																		...
																		<a class="preview_taxonomies" href="javascript:void(0);" style="top:-35px; float: right; position: relative;" rel="preview_taxonomies"><?php _e('Preview', 'wp-all-import-pro'); ?></a>
																		<div class="input">
																			<a href="javascript:void(0);" class="icon-item add-new-cat" style="width: 200px;"><?php _e('Add Another Hierarchy Group','wp-all-import-pro');?></a> 																			
																		</div>
																	</div>
																</div>
																<div class="input">
																	...
																	<label for="hierarchical_logic_manual_<?php echo $ctx->name;?>"><?php _e('Manually design the hierarchy with drag & drop', 'wp-all-import-pro'); ?></label>
																	<div class="switcher-target-hierarchical_logic_manual_<?php echo $ctx->name;?> sub_input">
																		<p style="margin-bottom: 10px;"><?php printf(__('Drag the <img src="%s" class="wpallimport-drag-icon"/> to the right to create a child, drag up and down to re-order.', 'wp-all-import-pro'), WP_ALL_IMPORT_ROOT_URL . '/static/img/drag.png'); ?></p>
																		...
																		<a href="javascript:void(0);" class="icon-item add-new-ico"><?php _e('Add Another Row','wp-all-import-pro');?></a>
																	</div>																	
																</div>
															</div>
														</div>
														...
														<div class="input" style="margin: 4px;">													
															...
															<label for="tax_mapping_<?php echo $ctx->name;?>"><?php printf(__('Enable Mapping for %s', 'wp-all-import-pro'), $ctx->labels->name); ?></label>
															<div class="switcher-target-tax_mapping_<?php echo $ctx->name;?> sub_input custom_type" rel="tax_mapping">
																<fieldset style="padding: 0;">															
																	<table cellpadding="0" cellspacing="5" class="tax-form-table" rel="tax_mapping_<?php echo $ctx->name; ?>" style="width: 100%;">
																		...
																		<tbody>	
																			...
																			<tr>
																				<td colspan="3">
																					<a href="javascript:void(0);" title="<?php _e('Add Another Rule', 'wp-all-import-pro')?>" class="action add-new-key add-new-entry"><?php _e('Add Another Rule', 'wp-all-import-pro') ?></a>
																				</td>
																			</tr>																	
																		</tbody>
																	</table>															
																...
																<div class="input">																	
																	...
																	<label for="tax_logic_mapping_<?php echo $ctx->name; ?>"><?php _e('Apply mapping rules before splitting via separator symbol','wp-all-import-pro'); ?></label>																	
																</div>
															</div>
														</div>															
													</div>											
                            ...
                            <div class="wpallimport-collapsed-content-inner">
                                ...
                                <table class="form-table" style="max-width:none;margin-top:1.5em;">
                                    ...
                                    <div class="input">
                                        ...
                                        <label for="do_not_create_terms"><?php _e('Do not create new terms', 'wp-all-import-pro'); ?></label><a href="#help" class="wpallimport-help" style="position: relative; top: -2px;" title="<?php _e('When this box is checked WP All Import will not create any terms and will only match existing terms on your site.</b>', 'wp-all-import-pro') ?>">?</a>
                                    </div>
	                                <?php if ($private_ctx): ?>
                                        <div class="input">
		...
		<div id="taxonomies_hints" style="display:none;">	
			<ul>
				<li><?php _e('Taxonomies that don\'t already exist on your site will be created unless the \'Do not create new terms\' option is checked.', 'wp-all-import-pro'); ?></li>
				<li><?php _e('To import to existing parent taxonomies, use the existing taxonomy name or slug.', 'wp-all-import-pro'); ?></li>
				<li><?php _e('To import to existing hierarchical taxonomies, create the entire hierarchy using the taxonomy names or slugs.', 'wp-all-import-pro'); ?></li>			
			</ul>
		</div>
	</div>
<?php endif; ?>		