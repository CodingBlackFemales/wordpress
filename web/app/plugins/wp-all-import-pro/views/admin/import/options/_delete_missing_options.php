...
<div class="switcher-target-is_delete_missing" style="padding-left:17px;">
    ...
    <label for="delete_missing_logic_import"><?php printf(__('Remove or modify %s created or updated by this import and then later removed from this import file', 'wp-all-import-pro' ), $cpt_name);?></label><br>
    ...
    <label for="delete_missing_logic_all"><?php printf(__('Remove or modify all %s on this site that are not present in this import file', 'wp-all-import-pro' ), $cpt_name);?></label><br>

    <h4><?php printf(__('What do you want to do with those %s?', 'wp-all-import-pro'), $cpt_name); ?></h4>
    ...
    <label for="delete_missing_action_keep"><?php _e('Instead of deletion...', 'wp-all-import-pro' );?></label><br>
    ...
    <div class="switcher-target-delete_missing_action_keep <?php if (empty($is_valid_delete_missing)): ?>delete-missing-error-wrapper<?php endif;?>" style="padding-left:26px;">
        <div class="delete-missing-error <?php if (!empty($is_valid_delete_missing)): ?>hidden<?php endif; ?>"><p><strong><?php _e('Error', 'wp-all-import-pro'); ?>:</strong> <?php _e('at least one option must be selected.', 'wp-all-import-pro'); ?></p></div>
            ...
            <?php if ( !in_array('is_send_removed_to_trash', $hidden_delete_missing_options) ): ?>
                <div class="input">
                    ...
                    <?php if ( $post_type == 'product' ): ?>
                        <label for="is_send_removed_to_trash"><?php printf(__('Send removed %s to trash', 'wp-all-import-pro'), $cpt_name); ?></label>
                        <a href="#help" class="wpallimport-help" title="<?php _e('Removed parent products will have all of their variations moved to the trash with them. If variations are removed from the import file and their parent product isn\'t, the variations will be disabled but will not be present in the trash. You can edit these disabled product variations in WooCommerce to manually reenable them.', 'wp-all-import-pro') ?>" style="top: -2px;">?</a>
                    <?php else: ?>
                        <label for="is_send_removed_to_trash"><?php printf(__('Send removed %s to trash', 'wp-all-import-pro'), $cpt_name); ?></label>
                    <?php endif; ?>
                    <?php if ( in_array('is_send_removed_to_trash', $disabled_delete_missing_options) ): ?>
                        <a href="#help" class="wpallimport-help" style="position: relative; top: -2px;" title="<?php printf(__('This option is not available when importing %s.', 'wp-all-import-pro'), $cpt_name) ?>">?</a>
                    <?php endif;?>
                </div>
            <?php endif; ?>
            <?php if ( !in_array('is_change_post_status_of_removed', $hidden_delete_missing_options) ): ?>
                <div class="input">
                    ...
                    <?php if ($post_type == 'gf_entries'): ?>
                        <label for="is_change_post_status_of_removed"><?php printf(__('Change %s property to', 'wp-all-import-pro'), $cpt_name); ?></label>
                    <?php else: ?>
                        <label for="is_change_post_status_of_removed"><?php printf(__('Change status of removed %s to', 'wp-all-import-pro'), $cpt_name); ?></label>
                    <?php endif; ?>
        ...
        <?php if ( !in_array('is_update_missing_cf', $hidden_delete_missing_options) ): ?>
            <div class="input">
                ...
                <label for="is_update_missing_cf"><?php printf(__('Set custom fields for removed %s', 'wp-all-import-pro'), $cpt_name); ?></label>
                ...
                <div class="switcher-target-is_update_missing_cf" style="padding-left:17px;">
                    ...
                    <table class="form-table custom-params" style="max-width:none; border:none; width:350px; margin-left:9px;">
                        <thead>
                        <tr>
                            <td style="padding-bottom:2px;font-weight:500;"><?php _e('Name', 'wp-all-import-pro') ?></td>
                            <td style="padding-bottom:2px;font-weight:500;"><?php _e('Value', 'wp-all-import-pro') ?></td>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        <tr>
                            <td colspan="2"><a href="javascript:void(0);" title="<?php _e('Add Custom Field', 'wp-all-import-pro')?>" class="action add-new-custom add-new-entry"><?php _e('Add Custom Field', 'wp-all-import-pro') ?></a></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <?php if ( $post_type == 'product' ): ?>
            <div class="input">
                ...
                <label for="missing_records_stock_status"><?php printf(__('Change stock status of removed %s to', 'wp-all-import-pro'), $cpt_name); ?></label>
                <select name="status_of_removed_products" style="height: 20px; width: 150px; font-size: 12px !important; padding-top: 2px;top:-1px;">
                    <option value="outofstock" <?php if ('outofstock' == $post['status_of_removed_products']):?>selected="selected"<?php endif; ?>><?php _e('Out of stock', 'wp-all-import-pro');?></option>
                    <option value="instock" <?php if ('instock' == $post['status_of_removed_products']):?>selected="selected"<?php endif; ?>><?php _e('In stock', 'wp-all-import-pro');?></option>
                </select>
                <!--                    <a href="#help" class="wpallimport-help" title="--><?php //_e('Option to set the stock status to out of stock instead of deleting the product entirely.', 'wp-all-import-pro') ?><!--" style="position:relative; top:-2px;">?</a>-->
            </div>
        <?php endif; ?>
    ...
    <label for="delete_missing_action_remove"><?php printf(__('Delete removed %s', 'wp-all-import-pro' ), $cpt_name);?></label><br>
    ...
    <div class="delete-missing-helper-texts">
        <div class="helper-text helper-text-1">
            <p><?php printf(__('When re-run, %s created or updated by this import and no longer present in the import file will be moved to the trash.', 'wp-all-import-pro'), $cpt_name); ?></p>
        </div>
        <div class="helper-text helper-text-2">
            <p><?php printf(__('When re-run, %s created or updated by this import and no longer present in the import file will be set to <span class="status_of_removed">draft</span>.', 'wp-all-import-pro'), $cpt_name); ?></p>
        </div>
        <div class="helper-text helper-text-3">
            <p><?php printf(__('This combination of options is potentially destructive. When re-run, %s created or updated by this import and no longer present in the import file will be deleted with no option for recovery.', 'wp-all-import-pro'), $cpt_name); ?></p>
        </div>
        <div class="helper-text helper-text-4">
            <p><?php printf(__('This combination of options can affect all %s on this site, even those not created by this import. During import, all %s not present in this import file will be moved to the trash.', 'wp-all-import-pro'), $cpt_name, $cpt_name); ?></p>
        </div>
        <div class="helper-text helper-text-5">
            <p><?php printf(__('This combination of options can affect all %s on this site, even those not created by this import. During import, all %s not present in this import file will be moved to <span class="status_of_removed">draft</span>.', 'wp-all-import-pro'), $cpt_name, $cpt_name); ?></p>
        </div>
        <div class="helper-text helper-text-6">
            <p><?php printf(__('This combination of options is potentially destructive. Every time this import is run, now and in the future, all %s not present in this import file will be deleted without further confirmation, even those not created by this import.', 'wp-all-import-pro'), $cpt_name); ?></p>
        </div>
    </div>

    <div class="delete-missing-confirmation-modal">
        <div class="confirmation-modal-1">
            <p><?php printf(__(' When this import is re-run in the future, %s created or updated by this import and no longer present in the import file will be sent to the trash.', 'wp-all-import-pro'), $cpt_name);?></p>
            <p><?php _e('We highly recommend running this import in a staging environment first and creating site backups before running in production.', 'wp-all-import-pro'); ?></p>
            <p><?php printf(__('This prompt can be disabled at <a href="%s" target="_blank">WP All Import settings page</a>.', 'wp-all-import-pro'), esc_url(add_query_arg(array('page' => 'pmxi-admin-settings'), $this->baseUrl))); ?></p>
            <div class="input">
                <p><?php _e('Please type the text below to confirm import settings:', 'wp-all-import-pro');?></p>
                <p>I HAVE BACKUPS</p>
                <input type="text" id="confirm-settings-1" style="width: 100%;"/>
            </div>
        </div>
        <div class="confirmation-modal-2">
            <p><?php printf(__(' When this import is re-run in the future, %s created or updated by this import and no longer present in the import file will be sent to <span class="status_of_removed">draft</span>.', 'wp-all-import-pro'), $cpt_name);?></p>
            <p><?php _e('We highly recommend running this import in a staging environment first and creating site backups before running in production.', 'wp-all-import-pro'); ?></p>
            <p><?php printf(__('This prompt can be disabled at <a href="%s" target="_blank">WP All Import settings page</a>.', 'wp-all-import-pro'), esc_url(add_query_arg(array('page' => 'pmxi-admin-settings'), $this->baseUrl))); ?></p>
            <div class="input">
                <p><?php _e('Please type the text below to confirm import settings:', 'wp-all-import-pro');?></p>
        ...
        <div class="confirmation-modal-3">
            <p><?php printf(__(' When this import is re-run in the future, %s created or updated by this import and no longer present in the import file will be deleted with no option for recovery.', 'wp-all-import-pro'), $cpt_name); ?></p>
            <?php if ( $post_type !== 'taxonomies' && !in_array('is_send_removed_to_trash', $hidden_delete_missing_options) ): ?>
                <p><?php _e('Consider testing this import with removed records sent to the trash to make sure that the import is configured correctly and that the record matching settings are working as expected. We highly recommend running this import in staging first, and creating site backups before running in production.', 'wp-all-import-pro');?></p>
            <?php else: ?>
                <p><?php _e('Consider testing this import by setting a custom field instead of deletion to make sure that the import is configured correctly and that the record matching settings are working as expected. We highly recommend running this import in a staging environment first and creating site backups before running in production.', 'wp-all-import-pro');?></p>
            <?php endif; ?>
            <p><?php printf(__('This prompt can be disabled at <a href="%s" target="_blank">WP All Import settings page</a>.', 'wp-all-import-pro'), esc_url(add_query_arg(array('page' => 'pmxi-admin-settings'), $this->baseUrl))); ?></p>
            <div class="input">
                <p><?php _e('Please type the text below to confirm import settings:', 'wp-all-import-pro');?></p>
        ...
        <div class="confirmation-modal-4">
            <p><?php printf(__(' This import can affect all %s on this site, even those not created by this import. During import, all %s not present in this import file will be moved to the trash.', 'wp-all-import-pro'), $cpt_name, $cpt_name); ?></p>
            <p><?php _e('We highly recommend running this import in a staging environment first and creating site backups before running in production.', 'wp-all-import-pro'); ?></p>
            <p><?php printf(__('This prompt can be disabled at <a href="%s" target="_blank">WP All Import settings page</a>.', 'wp-all-import-pro'), esc_url(add_query_arg(array('page' => 'pmxi-admin-settings'), $this->baseUrl))); ?></p>
            <div class="input">
                <p><?php _e('Please type the text below to confirm import settings:', 'wp-all-import-pro');?></p>
        ...
        <div class="confirmation-modal-5">
            <p><?php printf(__(' This import can affect all %s on this site, even those not created by this import. During import, all %s not present in this import file will be moved to <span class="status_of_removed">draft</span>.', 'wp-all-import-pro'), $cpt_name, $cpt_name); ?></p>
            <p><?php _e('We highly recommend running this import in a staging environment first and creating site backups before running in production.', 'wp-all-import-pro'); ?></p>
            <p><?php printf(__('This prompt can be disabled at <a href="%s" target="_blank">WP All Import settings page</a>.', 'wp-all-import-pro'), esc_url(add_query_arg(array('page' => 'pmxi-admin-settings'), $this->baseUrl))); ?></p>
            <div class="input">
                <p><?php _e('Please type the text below to confirm import settings:', 'wp-all-import-pro');?></p>
        ...
        <div class="confirmation-modal-6">
            <p><?php printf(__(' This import will delete all %s on site, even those not created by this import. Every time this import is run, now and in the future, all %s not present in this import file will be deleted without further confirmation.', 'wp-all-import-pro'), $cpt_name, $cpt_name); ?></p>
            <?php if ( $post_type !== 'taxonomies' && !in_array('is_send_removed_to_trash', $hidden_delete_missing_options) ): ?>
                <p><?php _e('Consider testing this import with removed records sent to the trash to make sure that the import is configured correctly and that the record matching settings are working as expected. We highly recommend running this import in staging first, and creating site backups before running in production.', 'wp-all-import-pro');?></p>
            <?php else: ?>
                <p><?php _e('Consider testing this import by setting a custom field instead of deletion to make sure that the import is configured correctly and that the record matching settings are working as expected. We highly recommend running this import in a staging environment first and creating site backups before running in production.', 'wp-all-import-pro');?></p>
