...
<div class="change_file">
			...
			<div class="error-headers exclamation">
				...
				<h4>
					...
					if ( ! empty($upload_validation) ):
						...
						printf(__('This %s file has errors and is not valid.', 'wp-all-import-pro'), $file_type);
					endif;
					?>
				</h4>
			</div>
	...
	<div class="wpallimport-content-section">
		<div class="wpallimport-collapsed-header" style="padding-left:30px;">
			<h3><?php _e('Import File','wp-all-import-pro');?></h3>
		</div>
				...
				<tr>
					<td colspan="3">
						...
						<div class="wpallimport-import-types">
							<h3><?php _e('Specify the location of the file to use for future runs of this import.', 'wp-all-import-pro'); ?></h3>
                        ...
                        <div class="wpallimport-download-resource-step-two">
                            <div class="wpallimport-download-resource wpallimport-download-resource-step-two-url">
                                <div class="wpallimport-file-type-options">
                                    ...
                                    <input type="text" class="regular-text" name="url" value="<?php echo ('url' == $import->type) ? esc_attr($import->path) : ''; ?>" placeholder="<?php _e('Enter a web address to download the file from...', 'wp-all-import-pro'); ?>"/>
                                    <!--a href="javascript:void(0);" class="wpallimport-download-from-url"><?php _e('Upload', 'wp-all-import-pro'); ?></a-->
                                </div>
                            ...
                            <div class="wpallimport-download-resource wpallimport-download-resource-step-two-ftp">
                                <div class="wpallimport-file-type-options">
                                    ...
                                    <input type="text" class="regular-text" name="ftp_host" value="<?php echo ( ! empty($import->options['ftp_host'])) ? esc_attr($import->options['ftp_host']) : ''; ?>" placeholder="<?php _e('Enter FTP server address', 'wp-all-import-pro'); ?>"/>
                                ...
                                <div class="wpallimport-file-type-options">
                                    ...
                                    <input type="text" class="regular-text" name="ftp_port" value="<?php echo ( ! empty($import->options['ftp_port'])) ? esc_attr($import->options['ftp_port']) : ''; ?>" placeholder="<?php _e('Enter FTP port', 'wp-all-import-pro'); ?>"/>
                                ...
                                <div class="wpallimport-file-type-options">
                                    ...
                                    <input type="text" class="regular-text" name="ftp_username" value="<?php echo ( ! empty($import->options['ftp_username'])) ? esc_attr($import->options['ftp_username']) : ''; ?>" placeholder="<?php _e('Enter FTP username', 'wp-all-import-pro'); ?>"/>
                                ...
                                <div class="wpallimport-file-type-options">
                                    ...
                                    <input type="text" class="regular-text" name="ftp_password" value="<?php echo ( ! empty($import->options['ftp_password'])) ? esc_attr($import->options['ftp_password']) : ''; ?>" placeholder="<?php _e('Enter FTP password', 'wp-all-import-pro'); ?>"/>
