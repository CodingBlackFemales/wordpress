						...
						<tr>
							<td>
								...
								<div class="wpallimport-unique-key-wrapper" <?php if (!empty(PMXI_Plugin::$session->deligate)):?>style="display:none;"<?php endif; ?>>
									<label style="font-weight: bold;"><?php _e("Unique Identifier", "wp-all-import-pro"); ?></label>
									...
									<a href="javascript:void(0);" class="wpallimport-auto-detect-unique-key"><?php _e('Auto-detect', 'wp-all-import-pro'); ?></a>
									<?php else: ?>
										<?php if ( ! empty($post['unique_key']) ): ?>
										<a href="javascript:void(0);" class="wpallimport-change-unique-key"><?php _e('Edit', 'wp-all-import-pro'); ?></a>
										<div id="dialog-confirm" title="<?php _e('Warning: Are you sure you want to edit the Unique Identifier?','wp-all-import-pro');?>" style="display:none;">
								...
								<div class="input" style="margin-bottom:15px; position:relative;">
									...
									<div style="margin-left: -4px;">
										<div class="input">
											...
											<label for="duplicate_indicator_title"><?php _e('Title', 'wp-all-import-pro' )?></label><br>
											...
											<label for="duplicate_indicator_content"><?php _e('Content', 'wp-all-import-pro' )?></label><br>
											<div class="input">
												...
												<label for="duplicate_indicator_custom_field"><?php _e('Custom field', 'wp-all-import-pro' )?></label><br>
											...
											<div class="input">
												...
												<label for="duplicate_indicator_pid"><?php _e('Post ID', 'wp-all-import-pro' )?></label><br>
