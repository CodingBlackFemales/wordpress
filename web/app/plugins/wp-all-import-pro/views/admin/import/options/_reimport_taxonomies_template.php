									...
									<div style="margin-left: -4px;">
										<div class="input">
											<div class="input">
												...
												<label for="duplicate_indicator_title"><?php _e('Name', 'wp-all-import-pro' )?></label>
											</div>
											...
											<div class="input">
												...
												<label for="duplicate_indicator_slug"><?php _e('Slug', 'wp-all-import-pro' )?></label>
											</div>
											...
											<div class="input">
												...
												<label for="duplicate_indicator_custom_field"><?php _e('Custom field', 'wp-all-import-pro' )?></label>
											</div>
											...
											<div class="input">
												...
												<label for="duplicate_indicator_pid"><?php _e('Term ID', 'wp-all-import-pro' )?></label>
											</div>
