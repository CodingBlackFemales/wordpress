					...
					<tr>
						<td colspan="3">
							...
							<div class="input">
								...
								<label for="is_fast_mode"><?php _e('Increase speed by disabling do_action calls in wp_insert_post during import.', 'wp-all-import-pro') ?>
									<a href="#help" class="wpallimport-help" style="position: relative; top: -2px;" title="<?php _e('This option is for advanced users with knowledge of WordPress development. Your theme or plugins may require these calls when posts are created. Next action will be disabled: \'transition_post_status\', \'save_post\', \'pre_post_update\', \'add_attachment\', \'edit_attachment\', \'edit_post\', \'post_updated\', \'wp_insert_post\'. Verify your created posts work properly if you check this box.', 'wp-all-import-pro') ?>">?</a></label>
							</div>
							<?php if ( ! $this->isWizard ): ?>

								<?php if ( 'taxonomies' == $post['custom_type'] ):?>
									<h4><?php _e('Taxonomy Type', 'wp-all-import-pro'); ?></h4>
									<p><?php _e('Editing this will change the taxonomy type of the taxonomies processed by this import. Re-run the import for the changes to take effect.', 'wp-all-import-pro');?></p> <br>
								<?php else: ?>
									<h4><?php _e('Post Type', 'wp-all-import-pro'); ?></h4>
									<p><?php _e('Editing this will change the post type of the posts processed by this import. Re-run the import for the changes to take effect.', 'wp-all-import-pro');?></p> <br>
								<?php endif; ?>
								...
								<?php endif; ?>
								<h4><?php _e('XPath', 'wp-all-import-pro'); ?></h4>
								<p><?php _e('Editing this can break your entire import. You will have to re-create it from scratch.', 'wp-all-import-pro');?></p> <br>
								<div class="input">
								...
								<h4><?php _e('CSV Delimiter', 'wp-all-import-pro'); ?></h4>
								<div class="input">
							...
							<div class="input">
								...
								<label for="is_import_specified"><?php _e('Import only specified records', 'wp-all-import-pro') ?> <a href="#help" class="wpallimport-help" style="position:relative; top:0;" title="<?php _e('Enter records or record ranges separated by commas, e.g. <b>1,5,7-10</b> would import the first, the fifth, and the seventh to tenth.', 'wp-all-import-pro') ?>">?</a></label>
							...
							<?php if (isset($source_type) and in_array($source_type, array('ftp', 'file'))): ?>
								<div class="input">
									...
									<label for="is_delete_source"><?php _e('Delete source XML file after importing', 'wp-all-import-pro') ?> <a href="#help" class="wpallimport-help" style="position:relative; top:0;" title="<?php _e('This setting takes effect only when script has access rights to perform the action, e.g. file is not deleted when pulled via HTTP or delete permission is not granted to the user that script is executed under.', 'wp-all-import-pro') ?>">?</a></label>
								</div>
							<?php endif; ?>
							<?php if (class_exists('PMLC_Plugin')): // option is only valid when `WP Wizard Cloak` pluign is enabled ?>
								<div class="input">
									...
									<label for="is_cloak"><?php _e('Auto-Cloak Links', 'wp-all-import-pro') ?> <a href="#help" class="wpallimport-help" style="position:relative; top:0;" title="<?php printf(__('Automatically process all links present in body of created post or page with <b>%s</b> plugin', 'wp-all-import-pro'), PMLC_Plugin::getInstance()->getName()) ?>">?</a></label>
								</div>
							<?php endif; ?>
							<div class="input">
							...
							<div class="input" style="margin-top: 15px;">
								<p><?php _e('Friendly Name','wp-all-import-pro');?></p> <br>
								<div class="input">
