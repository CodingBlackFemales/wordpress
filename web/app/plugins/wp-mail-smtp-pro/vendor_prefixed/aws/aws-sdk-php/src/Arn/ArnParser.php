...
use WPMailSMTP\Vendor\Aws\Arn\S3\AccessPointArn as S3AccessPointArn;
use WPMailSMTP\Vendor\Aws\Arn\ObjectLambdaAccessPointArn;
use WPMailSMTP\Vendor\Aws\Arn\S3\MultiRegionAccessPointArn;
use WPMailSMTP\Vendor\Aws\Arn\S3\OutpostsBucketArn;
use WPMailSMTP\Vendor\Aws\Arn\S3\RegionalBucketArn;
use WPMailSMTP\Vendor\Aws\Arn\S3\OutpostsAccessPointArn;
/**
