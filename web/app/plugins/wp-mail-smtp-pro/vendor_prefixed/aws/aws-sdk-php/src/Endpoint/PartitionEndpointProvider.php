...
namespace WPMailSMTP\Vendor\Aws\Endpoint;

use WPMailSMTP\Vendor\JmesPath\Env;
class PartitionEndpointProvider
{
    ...
    {
        $data = \WPMailSMTP\Vendor\Aws\load_compiled_json(__DIR__ . '/../data/endpoints.json');
        $prefixData = \WPMailSMTP\Vendor\Aws\load_compiled_json(__DIR__ . '/../data/endpoints_prefix_history.json');
