<?php
/**
 * View: Profile Subscriptions - Canceled subscription.
 *
 * @since 4.25.0
 * @version 4.25.0
 *
...
if (
	$subscription->get_status() !== Subscription::$status_canceled
) {
	return;
}
...
<div class="<?php echo esc_attr( implode( ' ', $classes ) ); ?>">
	...
	<div class="ld-profile__subscription-status-container">
		...
		<?php $this->template( 'shortcodes/profile/subscriptions/canceled/cancellation-date' ); ?>
	</div>
</div>
