...
namespace StellarWP\Learndash\MyCLabs\Enum\PHPUnit;
 ...
 *
 * \SebastianBergmann\Comparator\Factory::getInstance()->register(new \StellarWP\Learndash\MyCLabs\Enum\PHPUnit\Comparator());
 */
