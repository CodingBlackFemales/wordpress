...
class SearchResult extends StripeObject implements \Countable, \IteratorAggregate
{
    ...
    public function all($params = null, $opts = null)
    {
        ...
        if (!$obj instanceof \StellarWP\Learndash\Stripe\SearchResult) {
            throw new \StellarWP\Learndash\Stripe\Exception\UnexpectedValueException('Expected type ' . \StellarWP\Learndash\Stripe\SearchResult::class . ', got "' . \get_class($obj) . '" instead.');
        }
