<?php
/**
 * Groups OpenAPI Documentation.
 *
 * Provides OpenAPI specification for groups endpoints.
 * Currently based on V2 REST API: https://developers.learndash.com/rest-api/v2/v2-groups/.
 *
 * @since 5.0.0
 *
...
/**
 * Groups OpenAPI Documentation Endpoint.
 *
 * @since 5.0.0
 */
class Group extends LDLMS_V2_Endpoint {
	/**
	...
	protected function get_routes(): array {
		$endpoint = LearnDash_Settings_Section::get_section_setting( 'LearnDash_Settings_Section_General_REST_API', 'groups_v2' );
	...
	protected function get_tags(): array {
		return [ learndash_get_custom_label_lower( 'groups' ) ];
	}
}
