<?php
/**
 * Deprecated. Use LearnDash\Core\API\Controllers\Posts instead.
 *
...
use LearnDash\Core\API\Controllers\Posts;
...
_deprecated_file(
	__FILE__,
	'4.10.3',
	esc_html( LEARNDASH_LMS_PLUGIN_DIR . '/src/Core/API/Controllers/Posts.php' )
);
	...
	class LD_REST_Posts_Gutenberg_Controller extends WP_REST_Posts_Controller {
		...
		public function get_item_permissions_check( $request ) {
			_deprecated_function(
				__METHOD__,
				'4.10.3',
				esc_html( Posts::class . '::get_item_permissions_check' )
			);
		...
		public function get_items_permissions_check( $request ) {
			_deprecated_function(
				__METHOD__,
				'4.10.3',
				esc_html( Posts::class . '::get_items_permissions_check' )
			);
			...
			if ( learndash_is_valid_post_type( $this->post_type ) ) {
				 ...
				 */
				$can_view_archive = apply_filters_deprecated(
					'learndash_rest_wp_archive_viewable',
					[ $can_view_archive, $this->post_type, $request ],
					'4.10.3'
				);
		...
		public function get_items( $request ) {
			...
			$data = apply_filters_deprecated(
				'learndash_rest_wp_archive_repsonse', // cspell:disable-line.
				[ $data, $this->post_type, $request ],
				'4.10.3'
			);
