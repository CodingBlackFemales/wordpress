...
import { PanelBody, SelectControl, TextControl, ToggleControl, PanelRow, Disabled } from '@wordpress/components';
...
registerBlockType(
	block_key,
	{
		...
		edit: props => {
			const { attributes: { course_id, user_id, label, html_class, button, preview_show, preview_user_id, example_show }, setAttributes } = props;
