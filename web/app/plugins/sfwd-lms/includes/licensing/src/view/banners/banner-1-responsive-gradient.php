<?php
/**
 * Banner 1 responsive gradient template.
 *
 * @since 4.18.0
 * @version 4.18.0
 *
...
<div class="ld-banner" id="<?php echo esc_attr( $slug ); ?>">
	<div class="ld-banner-bg"
		style="background-image: linear-gradient(to right, <?php echo esc_attr( $bg_color_start ); ?> , <?php echo esc_attr( $bg_color_end ); ?>);">
