jQuery( function() {
	jQuery( 'table#learndash-data-upgrades button.learndash-data-upgrades-button' ).on( 'click', function( e ) {
		e.preventDefault();
		...
		if ( data_slug === 'rename-wpproquiz-tables' ) {
			...
			jQuery( 'button.learndash-data-upgrades-button-' + data_slug + '-reload', parent_tr ).on( 'click', function() {
	...
	if ( jQuery( 'table#learndash-data-upgrades tr#learndash-data-upgrades-container-rename-wpproquiz-tables' ).length ) {
		...
		jQuery( 'a.learndash-data-upgrades-show-tables', parent_tr ).on( 'click', function( e ) {
			e.preventDefault();
		...
		jQuery( 'input[name="learndash-data-upgrades-prefix"]', parent_tr ).on( 'change', function( e ) {
			e.preventDefault();
