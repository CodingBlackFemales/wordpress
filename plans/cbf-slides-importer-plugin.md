...
Because `order` is an index into the lesson list (A10), placement is applied by rewriting the whole course order in one sweep: collect the created lesson IDs per heading, then reorder.
